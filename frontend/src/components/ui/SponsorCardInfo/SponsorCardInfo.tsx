...
export const SponsorCardInfo: FC<SponsorCardInfoProps> = ({
    ...
    return (
        <div className={cn(className, 'grid grid-cols-[1fr,3fr] gap-x-[100px] pb-12 border-b-[1px] border-solid border-secondaryOpacity3')}>
            ...
            <div className='flex flex-col gap-y-8'>
                ...
                <div className='flex flex-row gap-x-2 items-center'>
                    <Image
                        ...
                        className='w-6 h-6'
                    />
                    <Link className='text-2xl text-secondary !leading-[normal]' href={url}>
                        {linkText}
                    </Link>
                </div>
            </div>
