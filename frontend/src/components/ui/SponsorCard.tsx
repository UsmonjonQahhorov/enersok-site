...
export const SponsorCard: FC<SponsorCardProps> = async ({
	...
	return (
		<article
			className={cn(
				className,
				'bg-white min-h-[85px] md:min-h-[213px] px-6 py-3 h-full w-full rounded-xl flex flex-row md:flex-col justify-center items-center hover:shadow-lg duration-200',
				// 'bg-[#F2F7FA]'
			)}
		>
			<NextImage
