            ...
            <section>
                <Container className='pt-[405px] flex flex-col items-center'>
                    <div className={cn(
                        ...
                        <p>In 2022, Enersok FE LLC was established as a result of a collaboration between four international corporations. The consortium that founded Enersok FE LLC consists of Electricite De France (EDF), a French energy giant, Nebras Power from Qatar, and Japanese corporations Sojitz Corporation and Kyuden International. Each of these participants brings extensive experience and influence in the energy sector, providing a strong foundation for the development of the new company.</p>
                        <h1>Key Members of the Consortium</h1>
                        <ul>
                            <li><b>Electricite De France (EDF)</b> – One of the largest energy players in the world. The French corporation specializes in electricity production, including nuclear, hydroelectric, and renewable energy.</li>
                            <li><b>Nebras Power</b> – A Qatari company that invests in global energy projects, focusing on long-term sustainability.</li>
                            <li><b>Sojitz Corporation</b> – A diversified Japanese corporation actively involved in various industries, including energy and infrastructure.</li>
                            <li><b>Kyuden International</b> – The international branch of Japan's Kyushu Electric Power, engaged in the development of energy projects worldwide.</li>
                        </ul>
                        <p>In 2022, Enersok FE LLC was established as a result of a collaboration between four international corporations. The consortium that founded Enersok FE LLC consists of Electricite De France (EDF), a French energy giant, Nebras Power from Qatar, and Japanese corporations Sojitz Corporation and Kyuden International. Each of these participants brings extensive experience and influence in the energy sector, providing a strong foundation for the development of the new company.</p>
                        <blockquote>In 2022, Enersok FE LLC was established as a result of a collaboration between four international corporations. The consortium that founded Enersok FE LLC consists of Electricite De France (EDF), a French energy giant</blockquote>
                        <p>Corporation and Kyuden International. Each of these participants brings extensive experience and influence in the energy sector, providing a strong foundation for the development of the new company.</p>
                    </div>
