...
export const generateMetadata: DynamicMetadata = async ({ params }): Promise<Metadata> => {
	...
	return {
		...
		keywords: locale === 'en' ? ['Enersok', 'Enersok company', 'Enersok energy'] : ['Enersok', 'Enersok kompaniyasi', 'Enersok energiya'],
		openGraph: {
			title: 'Enersok',
			type: 'website',
			url: 'https://example.com',
			description: locale === 'en' ? 'Enersok is a company that provides energy solutions for your home or business. We offer solar panels, battery storage, and electric vehicle charging stations to help you save money on your energy bills and reduce your carbon footprint.' : 'Enersok kompaniyasi uy yoki biznesingiz uchun energiya echimlarini taqdim etadi. Energiya hisobingizni tejash va karbon oʻtkazmangizni kamaytirish uchun quyidagi mahsulotlarni taklif qilamiz: quyosh paneli, batareya saqlash va elektr transport vositalarini zaryadlash stantsiyalari.',
			locale: locale,
		},
		twitter: {
