                ...
                <Container className='pt-[164px] pb-20'>
                    ...
                    <div className='flex flex-row gap-x-16'>
                        <div className='flex flex-col items-start gap-y-2'>
                            <Paragraph className='text-secondaryOpacity4 text-sm'>Location</Paragraph>
                            <Paragraph className='text-xl text-secondary'>Tashkent Headquarters</Paragraph>
                        </div>
                        <div className='flex flex-row gap-x-8'>
                            <div className='flex flex-col items-start gap-y-2'>
                                <Paragraph className='text-secondaryOpacity4 text-sm'>Posting Date</Paragraph>
                                <Paragraph className='text-xl text-secondary'>01.05.2024</Paragraph>
                            </div>
                            <div className='flex flex-col items-start gap-y-2'>
                                <Paragraph className='text-secondaryOpacity4 text-sm'>Location</Paragraph>
                                <Paragraph className='text-xl text-secondary'>30.08.2024</Paragraph>
                            </div>
                        </div>
                    </div>
                </Container>
