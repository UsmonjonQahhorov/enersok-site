		...
		<>
				...
				<Container className="pt-[164px] pb-11 grid grid-cols-2">
					<div>
						...
						<div className="pt-10 border-t-[1px] border-solid border-secondaryOpacity3 pb-40">
							<Heading className="text-3xl font-normal text-secondary mb-3">
								For a brighter future with us!
							</Heading>
							<Paragraph className="text-xl font-normal text-secondary">
			...
			<section>
				<Container>
					<Paragraph
						size="2xl"
						className="w-full pb-7 whitespace-[10px] py-[50px] text-secondary"
					>
					...
					<Heading
						as="h3"
						className="text-secondary uppercase font-normal text-[64px] pt-20 pb-8"
					>
						Latest Vacancies
					</Heading>
