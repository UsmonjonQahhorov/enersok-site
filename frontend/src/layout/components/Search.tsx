     ...
     return (
          ...
          >
               ...
               </search>
               {
                    isLoading && (
                         <ul
                              className="absolute top-14 -left-[70%] bg-white border border-gray-200 rounded-lg shadow-md p-5 gap-5 flex flex-col max-h-[300px] overflow-hidden overflow-y-auto w-[500px]"
                         >
                              <li
                                   className='p-4 border border-gray-200 rounded-lg shadow-md list-none animate-pulse min-h-[150px] bg-slate-300'
                              />
                         </ul>
                    )
               }
               {
                    status === 'success' && hasData && (
                         <ul
                              className="absolute top-14 -left-[70%] bg-white border border-gray-200 rounded-lg shadow-md p-5 gap-5 flex flex-col max-h-[300px] overflow-hidden overflow-y-auto w-[600px]"
                         >
                              {/*  News */}
                              {
                                        ...
                                        >
                                             ...
                                             >
                                                  ...
                                                  >
                                                       <Calendar size={20} />
                                                       <span>
                                                            {Time(news.preview_date).format('DD.MM.YYYY')}
                                                       </span>
                                                  </div>
                                                  <div
                                                  ...
                                                  >
                                                       {
                                                            news.news_description ? news.news_description : news.news_description_full
                                                       }
                                                  </Paragraph>
                                                  {/* More Button */}
                                                  <Link
                                   ...
                                   >
                                        ...
                                        >
                                             ...
                                             >
                                                  <Calendar size={20} />
                                                  <span>
                                                       {Time(vacancy.publishedAt).format('DD.MM.YYYY')}
                                                  </span>
                                             </div>
                                        ...
                                        >
                                             ...
                                             >
                                                  ...
                                                  >
                                                       <Calendar size={20} />
                                                       <span>
                                                            {Time(document.createdAt).format('DD.MM.YYYY')}
                                                       </span>
                                                  </div>
                                                  <div
                                                       className='flex gap-2'
